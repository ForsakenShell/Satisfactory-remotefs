...
---Return this Vector2f as a string using the supplied pattern or default Vector2f.pattern
---@param pattern? string Optional pattern to use for string.format()
---@return string formatted string
function Vector2f:ToString( pattern )
    pattern = pattern or self.pattern
    return string.format( pattern, self.x, self.y )
end

---Return the Vector2f? as a string using the supplied pattern or default Vector2f.pattern
---@param v table vector
---@param pattern? string Optional pattern to use for string.format()
---@return string formatted string
function Vector2f.ToString( v, pattern )
    ...
    pattern = pattern or Vector2f.pattern
